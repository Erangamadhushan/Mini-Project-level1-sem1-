        ...
        district:[
            {
                ...
                places:[
                    ...
                    },
                    {
                        place:"Mount Lavinia",
                        example:[
                            "Famous beach and colonial-era hotel"
                        ]
                    },
                    {
                        place:"Kelaniya",
                        example:[
                            "Historic Raja Maha Vihara temple"
                        ]
                    }
                ]
            },
    ...
    },
    {
        ...
        district:[
            ...
            },
            {
                ...
                places:[
                    {
                        place:"Kilinochchi Town",
                        example:[
                            "Emerging tourist spot"
                        ]
                    },
                    {
                        place:"Iranamadu Tank",
                        example:[
                            "Water reservoir"
                        ]
                    }
            ...
            },
            {
                ...
                places:[
                    {
                        place:"Mullaitivu Beach",
                        example:[
                            "Pristine coastline"
                        ]
                    },
                    {
                        place:"Kokkilai Lagoon",
                        example:[
                            "Bird watching"
                        ]
                    }
        ...
        district:[
            ...
            },
            {
                ...
                places:[
                    ...
                    {
                        place:"Lahugala National Park",
                        example:[
                            "Elephants"
                        ]
                    },
                    {
                        place:"Kudumbigala Monastery",
                        example:[
                            "Ancient ruins"
                        ]
                    }
